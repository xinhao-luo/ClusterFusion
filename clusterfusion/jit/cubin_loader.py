...
from .env import CLUSTERFUSION_CACHE_DIR

# This is the storage path for the cubins, it can be replaced
# with a local path for testing.
CLUSTERFUSION_CUBINS_REPOSITORY = os.environ.get(
    "CLUSTERFUSION_CUBINS_REPOSITORY",
...
def setup_cubin_loader(dll_path: str):
    ...
    def get_cubin_callback(name, sha256):
        ...
        _LIB.CLUSTERFUSIONSetCurrentCubin(
    ...
    _LIB.CLUSTERFUSIONSetCubinCallback(cb)