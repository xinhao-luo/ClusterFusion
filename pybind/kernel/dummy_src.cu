...
int main(int argc, char **argv) { 
    ...
    fill_matrix_from_file(h_kv_cache, 2*HEAD_NUM * HEAD_DIM * SEQ_LEN, "data/h_kv_cache");
    ...
    fill_matrix_from_file(h_w_rms_input, HIDDEN_DIM, "data/h_rms_input");
    fill_matrix_from_file(h_w_rms_attn, HIDDEN_DIM, "data/h_rms_attn");
    fill_matrix_from_file(h_rope_cos, HEAD_DIM, "data/h_rope_cos");
    fill_matrix_from_file(h_rope_sin, HEAD_DIM, "data/h_rope_sin");
